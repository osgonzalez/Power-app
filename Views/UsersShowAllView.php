...
<div class="col-md-12">
  ...
  <?php      foreach ($this->users as $user){ ?>
      ...
      <td><?php  echo '<a href="../Controllers/UserActionController.php?DNI='.$user->getDNI().'&action=EDIT"><img src="../Templates/img2/edit.png" style="width:30px;height:30px;" title="Editar"></a>'; ?></td>
