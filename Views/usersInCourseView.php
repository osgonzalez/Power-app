...
<div class="col-md-12">
  ...
  ?>
        ...
        <div id="showback">
            <?php
            echo '<a class="submit" href="../Controllers/RegistroUserCourseController.php?IDCourses='.$this->course->getIDCourses().'"><img src="../Templates/img2/userAdd.png" style="width:45px;heigh:45px;" title="Inscribir usuario"></a>';
