    ...
    <div class="row mt">
        <div class="col-lg-12">
            <div class="form-panel">
                ...
                <form method="post" class="form-horizontal style-form" action="../Controllers/ExerciseActionController.php?action=EDIT">
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 col-sm-2 control-label">Tipo de Ejercicio</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control round-form" name="ExerciseType" value="<?php echo $this->exercise->getExerciseType();?>">
                        </div>
                    </div>
