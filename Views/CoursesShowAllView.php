...
<?php
        foreach ($this->courses as $course){ ?>
            ...
            <td> <?php echo $course->getIDCourses(); ?></td>
                ...
                <td><?php echo '<a href=""><img src="../Templates/img2/userAdd.png" style="width:30px;height:30px;" title="Añadir deportista"></a>';?></td>
                <td><?php echo '<a href="../Controllers/formLoader.php?DNI='.$course->getIDCourses().'&form=courseEdit"><img src="../Templates/img2/edit.png" style="width:30px;height:30px;" title="Editar"></a>';?></td>
                <td><?php echo '<a href="../Controllers/CoursesActionController.php?DNI='.$course->getIDCourses().'&action=DELETE"><img src="../Templates/img2/delete.png" style="width:30px;height:30px;" title="Borrar"></a>';?></td>
